...
import net.maxflorescence.cobblemonsimplecreation.fluid.ModFluidTypes;
import net.maxflorescence.cobblemonsimplecreation.fluid.ModFluids;
import net.maxflorescence.cobblemonsimplecreation.item.ModItems;
...
*/
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> MOD_TAB = CREATIVE_MODE_TABS.register("cobblemon_simple_creation", () -> CreativeModeTab.builder()
            ...
            .displayItems((parameters, output) -> {
                ...
                output.accept(ModItems.RARE_CANDY_GLOB.get());
